...
public class VentanaSwing extends JFrame{
    ...
    public VentanaSwing() throws HeadlessException {
        setTitle("Conversion de grados °C a °F");   //titulo
        setSize(400, 300);
        setLayout(new FlowLayout(FlowLayout.CENTER));   //alineacion
        ...
        this.boton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
             ...
             float celcius = 0.0f;  
             try {
                 celcius=Float.parseFloat(cuadro.getText()); //recuperar el valor ingresado en el cuadro de la ventana
